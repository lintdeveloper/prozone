...
class _HomeScreenState extends State<HomeScreen> {
      ...
      body: ResponsiveSafeArea(builder: (context, size) {
        return Column(
          children: [
                                ...
                                Container(
                                  ...
                                  child: Chip(
                                    ...
                                    label: Container(
                                        ...
                                        height: 20,
                                        child: Center(
                                            child: Text(_selectedActiveStatus,
                                              style: TextStyle(
                                                  color: Colors.white,
                                ...
                                child: FutureBuilder<List<ProviderType>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return snapshot.hasData ? Wrap(
                                        alignment: WrapAlignment.start,
                                        children: snapshot.data.map((providerType) => Container(
                                          ...
                                          child: ActionChip(
                                            ...
                                            onPressed: () {
                                              setState(() {
                                                _selectedActiveStatus = providerType.name;
                                              });
                                            },
                                            backgroundColor: Colors.grey[200],
                                            shape: StadiumBorder(
            ...
            Expanded(
              child: isFilter ? Container() : SingleChildScrollView(
  ...
  Future<List<ProviderType>> getProviderTypeAction(
    ...
    List<ProviderType> responsePayload =
    await helper.getCustomProviderType(
        authToken: _token, errorCallback: errorCallback);
