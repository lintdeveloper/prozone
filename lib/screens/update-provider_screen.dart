...
class UpdateProviderScreen extends StatefulWidget {
  static String routeName = "/update-provider";
...
class _UpdateProviderScreenState extends State<UpdateProviderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final CustomProviderResponse customProviderResponse = ModalRoute.of(context).settings.arguments;
                    ...
                    children: [
                      ...
                      GestureDetector(
                          onTap: () {
                            ...
                            form.save();
                            print(_providerName);
                            print(_providerDescription);
                            print(_providerAddress);
                            print(_selectedState);
                            print(_selectedProviderType);
                            print(_selectedActiveStatus);
                            if (form.validate()) {
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  focusedBorder: OutlineInputBorder(
                                      ...
                                      borderSide: BorderSide(color: GREEN_HUE)),
                                  filled: false),
                              initialValue: customProviderResponse.name,
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(color: GREEN_HUE)),
                                filled: false),
                            initialValue: customProviderResponse.description,
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  focusedBorder: OutlineInputBorder(
                                      ...
                                      borderSide: BorderSide(color: GREEN_HUE)),
                                  filled: false),
                              initialValue: customProviderResponse.address,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:
                                        ...
                                        value: customProviderResponse.state,
                                        style: TextStyle(
                                            fontSize: 14,
                                            color: BLUE_HUE.withOpacity(0.7)),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:
                                        ...
                                        iconEnabledColor: GREEN_HUE,
                                        value: customProviderResponse.providerType,
                                        style: TextStyle(
                                            fontSize: 14,
                                            color: BLUE_HUE.withOpacity(0.7)),
                          ...
                          Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  RatingBar.builder(
                                    initialRating: double.parse(customProviderResponse.rating.toString()),
                                    minRating: 1,
